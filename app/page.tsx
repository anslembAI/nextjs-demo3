      ...
      <section className="relative z-20 -mt-24 pb-20 container px-4 md:px-6">
        <div className="bg-card rounded-2xl shadow-xl border border-border/50 p-6 md:p-8 max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1">
            {/* Simplified Widget for Layout Purpose - linking to full form or putting abbreviated fields */}
            {/* For now, just reusing InquiryForm but maybe styled horizontally. 
                 Since InquiryForm is vertical stack, let's keep it simply or create a horizontal version.
                 Let's just use the vertical one but in a grid or just Keep it simple as a 'Quick Inquiry' that opens a modal or just is the form.
                 The prompt asked for a widget. I'll put the form here directly.
             */}
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="mt-12 text-center">
            <Button size="lg" variant="secondary" className="gap-2" asChild>
              <Link href="/destinations">Explore All Destinations <ArrowRight className="w-4 h-4" /></Link>
            </Button>
          </div>
        </div>
      </section>
